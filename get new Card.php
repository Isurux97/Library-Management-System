...
<body>
	...
	<div class="container">
  <h2 style="text-align: left;">Get a new card</h2>
    <h5 style="text-align: left;">Have you lost your card or need to get a new card?</a></h5>
    <h5><b>fill this one</b></h5>
    <br>

  <form action="new card.php" method="post">
    <div class="form-group">
      <label for="text">First name</label>
      <input type="text" class="form-control" id="name" placeholder="Your First name" style="width: 250px" name="fname">
    </div>
    <br>

    <div class="form-group">
      <label for="text">Last name</label>
      <input type="text" class="form-control" id="name" placeholder="Your Last name" style="width: 250px" name="lname">
    </div>
    <br>

    <div class="form-group">
      <label for="text">Registraion number</label>
      <input type="text" class="form-control" id="reg number" placeholder="Eg: 2018/ASB/24" style="width: 210px" name="regnum">
    </div>
    <br>
    ...
    <button type="submit" class="btn btn-primary" value="submit"> <a href="Check your E mail.html">Submit</a></button>
  </form>
</div>
